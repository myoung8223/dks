// Digispark Case
// By: Mike Young - May 8, 2026 - Version 6
...
rndr = 1;   // 0: render bottom, 1: render top
...
cwt = 2;    // case wall thickness
sh = 4.3;   // switch height
